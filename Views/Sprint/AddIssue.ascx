...
<div>
    ...
    <Span style="float:right;" title="List all the issues with check boxes for selection">[ <%: Html.ActionLink("Show All", "ShowAllIssues", "Sprint", null, new { id = "showAllLink" })%> ]</Span>
    <br />
    <h3>Enter the issue ID to add in Sprint Backlog.</h3>
    <% using (Html.BeginForm("AddIssue", "Sprint", FormMethod.Post, new { id = "addIssueForm" }))
        { %>
        <br />
