...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div id="customFieldsTab">
        ...
        <% using (Html.BeginForm("AddCustomFields", "Sprint"))
           { 
        %>
                ...
                <% if (Model.FirstOrDefault() != null)
                   {%>
                    <thead title="Click to Sort the List"> 
                        <tr>
                            <th>
                                <h3>Select the Custom Field(s) for the Sprint being created.</h3>
                           </th>
                        </tr>
                     </thead>
                        ...
                        <%foreach (var item in Model)
                           { %>
                            <tr>
                                    ...
                                    <%: Html.RenderControl(new ControlInfo()
                                                            {
                                                                ...
                                                                Value = (CustomControlsInfo.CustomControlsID.Contains(item.SprintAttID))?"Yes":null,
                                ...
                                <td>
                                    <%: Html.ActionLink("Details", "DisplayFieldInfo", new { pFieldID = item.SprintAttID }, new { name = "dAjaxLink" })%> |
                                    <%: Html.ActionLink("Edit", "EditFieldInfo", new { pFieldID = item.SprintAttID }, new { name = "ajaxLink" })%>
                                </td>
                           </tr>
                    <% } %>
                </tbody>
