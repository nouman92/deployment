...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div id="customFieldsTab">
        <% using (Html.BeginForm("AddCustomFields", "Employee"))
           { 
        %>
        <table class="bodyTable" id="customFieldsTable">
            ...
            <thead title="Click to Sort the List">
                <tr>
                    <th>
                        <h3>
                            Select the Custom Field(s) for the User being created.</h3>
                    </th>
                </tr>
            </thead>
            <tbody class="rowHover">
                ...
                <tr>
                        ...
                        <%: Html.RenderControl(new ControlInfo()
                                                        {
                                                            ...
                                                            Value = (CustomControlsInfo.CustomControlsID.Contains(item.EmpAttID))?"Yes":null,
                    ...
                    <td>
                        <%: Html.ActionLink("Details", "DisplayFieldInfo", new { pFieldID = item.EmpAttID }, new { name = "dAjaxLink" })%>
                        |
                        <%: Html.ActionLink("Edit", "EditFieldInfo", new { pFieldID = item.EmpAttID }, new { name = "ajaxLink" })%>
                    </td>
                </tr>
                <% } %>
            </tbody>
        ...
        <span class="controlPortion">
            <input type="checkbox" id="selectAll" value="Select All" /><b>Select All</b></span>
        <br />
        <br />
