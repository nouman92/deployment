...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <h3>User Details</h3>
    <br />
    <% using (Html.BeginForm("EditEmployee", "Employee", new { pEmployeeID = Model.FirstOrDefault().EmpID }, FormMethod.Post, new { id = "editEmployee" }))
       { %>
    ...
    <br />
    <input class="buttonDesign" type="submit" value="Save" id="create" />
    <a class="linkButton2" href='<%: Url.Action("MoreActionsTabs", "Employee") %>'> <span> Cancel </span></a>
    <br />
    <%} %>
