...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <script type="text/javascript">
        ...
        $('#cancel2').click(function () {
            $('#createComponentTabs').tabs('select', 0);
            return false;
        });
    ...
    <div id="customFieldsTab">
        ...
        <% using (Html.BeginForm("AddCustomFields", "Component"))
           { 
        %>
                ...
                <% if (Model.FirstOrDefault() != null)
                   {%>
                    <thead title="Click to Sort the List"> 
                        <tr>
                            <th>
                                <h3>Select the Custom Field(s) for the Component being created.</h3>
                           </th>
                        </tr>
                     </thead>
                        ...
                        <%foreach (var item in Model)
                           { %>
                            <tr>
                                    ...
                                    <%: Html.RenderControl(new ControlInfo()
                                                            {
                                                                ...
                                                                Value = (CustomControlsInfo.CustomControlsID.Contains(item.CompAttID))?"Yes":null,
                                ...
                                <td>
                                    <%: Html.ActionLink("Details", "DisplayFieldInfo", new { pFieldID = item.CompAttID }, new { name = "dAjaxLink" })%> |
                                    <%: Html.ActionLink("Edit", "EditFieldInfo", new { pFieldID = item.CompAttID }, new { name = "ajaxLink" })%>
                                </td>
                           </tr>
                    <% } %>
                </tbody>
