<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<Domain.Entities.IssueAttribute>" %>

<% if (ViewData["issueIDField"] == null)
   {%>
    <%: Html.RenderControl(new ControlInfo()
                                {
                                    ...
                                    ControlAttName = Model.IssueAttName,
