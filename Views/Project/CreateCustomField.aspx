...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <script type="text/javascript">
        ...
        $("input[name='_1']").blur(function () {
            $.get('<%: Url.Action("IsFieldExists", "Project")  %>', { pFieldName: $("#createCustomField input[name='_1']").val() }, function (data) {
                if (data == "True") {
    ...
    <div id="newCustomFieldTab">
        <h5>
            ...
            <br />
            <i>* Organization Level field will be available in all Projects by default from onwards.</i> <span class="helpSign" title="Will not modify later"><b>&nbsp!&nbsp</b></span>
            <br />
        </h5>

        <h3>Please provide the following information:</h3>
        <br />
        <% using (Html.BeginForm("CreateCustomField", "Project", FormMethod.Post, new { id = "createCustomField" }))
           { %>
